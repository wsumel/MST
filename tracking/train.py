...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str,default='mst', help='training script name')
    parser.add_argument('--config', type=str, default='vitt_256_mae_32x4_ep100_got', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str,default='/disk3/wsl/disk3/wsl_tmp/mst-tiny/result-tiny-test', help='root directory to save checkpoints, logs, and tensorboard')
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = "torchrun --standalone --nnodes=1 --nproc_per_node %d --master_port %d lib/train/run_training.py " \
